            ...
            <details>
              ...
              <div className="px-4 pb-4">
                <p>
                  ...
                  the Identity Provider(IdP). Authentication server verifies the
                  credentials and issues a jwt signed using either a secret salt
                  or a private key. User's Client uses the JWT to access
